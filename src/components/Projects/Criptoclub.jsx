  ...
  return (
    <div className="">
      <div className="absolute top-0 left-0 z-0">
        <div className="mb-24">
          <img
            src="../assets/criptoclubexpanded.png"
      ...
      <div className="z-[9] relative p-4 -ml-32 md:mt-44 mt-20">
        <h1 className="text-black text-3xl font-bold">Criptoclub Website</h1>
        <div className="my-3">
        ...
        <div className="my-3">
          ...
          <ul>
            <li className="text-black">Carlos González</li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 mb-28">
        <div className="">
          ...
          <h3 className="mb-4">October 2022 - January 2023</h3>
        ...
        <div className="-ml-10 mr-10">
          <h3 className="text-xl font-semibold text-stone-900 dark:text-white mb-3">
            Introducing Criptoclub website
          </h3>
          <p>
