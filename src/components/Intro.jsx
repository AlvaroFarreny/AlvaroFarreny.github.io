...
function Intro() {
  return (
    <div className="flex items-center justify-center flex-col text-center pb-6 mb-4 md:mt-80 mt-56 ">
      <p className="text-base md:text-xl mb-3 font-medium z-[9]">
        Computer Science student
      </p>
      <h1 className="text-4xl md:text-7xl dark:text-white mb-2 md:mb-4 font-bold z-[9]">
        Álvaro Farreny
      </h1>

      <div className="container max-w-screen-lg mx-auto z-[9]">
        <div>
