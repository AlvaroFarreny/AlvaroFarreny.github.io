...
const Listing = ({ data, open }) => {
  ...
  return (
    <motion.div className="listing" onClick={open} whileHover={{ scale: 1.1 }}>
      <div className="z-1 absolute left-0 top-0 w-full h-full bg-white overflow-hidden border-2 border-stone-900 dark:border-white rounded-md bg-white dark:bg-slate-900 text-slate-900 dark:text-stone-300">
